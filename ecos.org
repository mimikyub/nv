...
** Réaliser un électrocardiogramme de repos 18 dérivations     :PRO:SDD_185:
** Identifier les situations cliniques où un électrocardiogramme doit être réalisé en urgence :CLI:SDD_185:
** Identifier les situations cliniques ou un monitoring continu de l'électrocardiogramme est nécessaire et enclencher la surveillance :INT:SDD_185:
** Interpréter de manière structurée un électrocardiogramme    :ICO:SDD_185:
** Identifier les critères de qualité et de bonne réalisation d'un ECG :ICO:SDD_185:
** Identifier les anomalies électrocardiographiques devant amener une réponse thérapeutique urgente :ICO:SDD_185:
** Prescrire et expliquer un enregistrement électrocardiographique de longue durée (Holter) :DGP:SDD_185:
** Identifier les situations d'urgences justifiant une hospitalisation et d'une surveillance continue :URG:SDD_185:
---
